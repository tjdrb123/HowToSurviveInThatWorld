...
{
    public class SO_StatCollectionEditor<T> : VisualElement where T: ScriptableObject
    {
        #region Fields
        ...
        public SO_StatCollectionEditor()
        {
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                "Assets/__Scripts__/Model/_Core_/StatusSystem/Editor/SO/SO_StatCollectionEditor.uxml");
        ...
        #region Initialized & InternalInit
